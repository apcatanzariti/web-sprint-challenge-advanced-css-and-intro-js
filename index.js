...
function get20s(array){
  ...
  for (let i = 0; i < array.length; i++) {
    if (array[i].years.startsWith(19, 0) && array[i].years.startsWith(19, 7)) {
...
function addArtist(array){
    array.push( {id: 20, name: 'Anthony', years: 'Your Birth Year - current day', genre: 'Web Design', nationality: 'Italian', bio: 'I am pretty good at drawing. I used to draw during school while listening to the teacher.' });
    return array;
  }
